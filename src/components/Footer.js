    ...
    <div className={classes.root}>
      <Box
        ...
        <Grid item xs={12} md={3}>
            <h2>Follow us</h2>
            <p>
            <a href="https://www.instagram.com/cpnxt/" target="_blank" className={classes.links}>Instagram</a>
            <br/><a href="https://twitter.com/cpnxt" target="_blank" className={classes.links}>Twitter</a>
            <br/><a href="https://www.moreperfectaf.com/" target="_blank" className={classes.links}>Podcast</a>
            </p>
        </Grid>
        </Grid>
      </Box>
